  ...
  <style>
    ...
    <div class="content">  
		...
		<form action="reportGen" method="POST">
            <div class="dropdown1">
    					<button class="dropbtn1" name="stock"><i class="fa fa-sort" aria-hidden="true"></i>	Stock Issue Report
      					</button>
              ...
              <div class="dropdown2">
              <a href="monthlyspare"><button class="dropbtn2" name="spare">Spare Part Stock Report</button></a>
      					<!-- </button>
    					<div class="dropdown2-content2">
      						<a href="monthlyspare">Monthly</a>
      						<a href="annualspare">Annualy </a>
     					</div> -->
              </div> 
        </div>
    ...
    Highcharts.chart('container', {
        ...
        title: {
            text: 'Current Spare Parts Stock Items'
        },
        tooltip: {
            ...
            data: [
                ...
                if ($this->data->num_rows>0){
                    while ($row = $this->data->fetch_object()){
                        $data.='{ name:"'.$row->name.'",y:'.$row->quantity.'},';
                    }
                }
                echo $data;
                ?>
...
<div id = "container2" style = "width: 500px; height: 400px; margin: 0 auto">
    ...
    Highcharts.chart('container2', {
        ...
        title: {
            text: 'Current Spare Part Stock according to categories'
        },
        tooltip: {
            pointFormat: '{series.name}: <b>{point.percentage:.1f}%</b>'
        },

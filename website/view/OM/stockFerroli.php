                  ...
                  <tbody>	
                    ...
                    <?php
                      ...
                      if($this->data!=0){
                        ...
                        <td>
                          <button type="submit" name="additem" class="btn btn-info" value="<?php echo $values['ModelID']?>">Add</button>
                        </td></form>
                        <td>
                         <button class="btn" name="delete" id="<?php echo $values['ModelID']?>" onclick="deleteItem(this)"><i class="fas fa-trash-alt"></i></button>
                        </td>
                      </tr>
                        <?php
                        }
...
.then((willDelete) => {
    if (willDelete) {
        window.location.assign("deleteferroli/"+itemid);
    }
});
}

                    ...
                    <tr>
                      <td>
                        <div class="row">
                          ...
                          <div class="col-30">
                              <input type="text" name="id" id="id" size="50" value="<?= isset($this->detail[0]['u_id']) ? $this->detail[0]['u_id'] : ''; ?>">
                    ...
                    <tr>
                      <td>
                        <div class="row">
                          ...
                          <div class="col-30">
                              <input type="text" name="name" id="name" size="50" value="<?= isset($this->detail[0]['f_name']) ? $this->detail[0]['f_name'] : ''; ?>">
                          </div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="row">
                          ...
                          <div class="col-30">
                              <input type="text" name="mail" id="mail" size="50" value="<?= isset($this->detail[0]['email']) ? $this->detail[0]['email'] : ''; ?>">
                          </div>
                        </div>
                      </td>
                    </tr>
                    <tr>
                      <td>
                        <div class="row">
                          ...
                          <div class="col-30">
                              <input type="text" name="add" id="add" size="50" value="<?= isset($this->detail[0]['address']) ? $this->detail[0]['address'] : ''; ?>">
                          </div>
                        </div>
                      </td>
                    </tr>
                    <tr colaspan='2'>
                      <td>
                        <div class="row">
                          ...
                          <div class="col-30">
                              <input type="text" name="tp" id="tp" size="50" value="<?= isset($this->detail[0]['contact']) ? $this->detail[0]['contact'] : ''; ?>">
                          </div>
                        </div>
                      </td>
                    </tr>
